...
public static class Logging
{
    ...
    {
        logger.LogInformation(new EventId(1, typeof(Logging).Namespace), "Entity not found. Name: {name}, Expression: {methodName}, PrimaryKey: {filter}", name, methodName, filter);
    }
